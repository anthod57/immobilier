            ...
            <Wrapper>
                ...
                <div className="search-container">
                    <div className="selects">
                        ...
                        <div className="row">
                            <span className="price"><input onChange={(e) => dispatch(setProps({ minBudget: +e.target.value }))} defaultValue={searchProps.props.minBudget} id="min-budget" className="input-text" type="number" min="0" step="100" placeholder={"Budget min."} /></span>
                            <span className="price"><input onChange={(e) => dispatch(setProps({ maxBudget: +e.target.value }))} defaultValue={searchProps.props.maxBudget} id="max-budget" className="input-text" type="number" min="0" step="100" placeholder={"Budget max."} /></span>
                        </div>
                        <div className="row">
                            <span className="surface"><input alt={"test"} onChange={(e) => dispatch(setProps({ minSurface: +e.target.value }))} defaultValue={searchProps.props.minSurface} id="min-surface" className="input-text" type="number" min="0" step="1" placeholder={"Surface min."} /></span>
                            <span className="surface"><input onChange={(e) => dispatch(setProps({ maxSurface: +e.target.value }))} defaultValue={searchProps.props.maxSurface} id="max-surface" className="input-text" type="number" min="0" step="1" placeholder={"Surface max."} /></span>
                        </div>
                    </div>
