...
export const SearchBar = (props) => {
    ...
    useEffect(() => {
        setOfferType(OFFER_TYPE[searchProps.props.offerType].value);
        setPropertyType(PROPERTY_TYPE[searchProps.props.propertyType].value);
        setLocation(searchProps.props.location.value);
        setMaxBudget(searchProps.props.maxBudget);
        setMinSurface(searchProps.props.minSurface);
    }, [searchProps])
